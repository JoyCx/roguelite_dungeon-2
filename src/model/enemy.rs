...
pub struct Enemy {
    ...
    pub attacks: Vec<crate::model::enemy_type::EnemyAttack>, // attack patterns this enemy can use
    #[serde(skip)]
    pub current_attack_index: usize, // tracks which attack pattern we're currently using
}
