...
pub struct Settings {
    ...
    pub skip_logo_animation: bool, // Skip the logo loading animation
}
...
impl Default for Settings {
    fn default() -> Self {
        Self {
            ...
            skip_logo_animation: false, // Don't skip by default
        }
    }
}
